    ...
    return (
        <section className={s.categoryContainer}>
            <div className={s.categoryContainer__wrapper}>
                ...
                <div className={s.categoryContainer__wrapper__item}>
                    <img width="50" height="50" src="https://img.icons8.com/clouds/50/react.png" alt="react" />
                    React
                </div>
                <div className={s.categoryContainer__wrapper__item}>
                    <img width="50" height="50" src="https://img.icons8.com/fluency/50/imac-settings.png" alt="imac-settings" />
                    Web Development
                </div>
                <div className={s.categoryContainer__wrapper__item}>
                    <img width="50" height="50" src="https://img.icons8.com/clouds/50/apple-tips.png" alt="apple-tips" />
                    Learning Tips
                </div>
            </div>
        </section>
