import s from "./RecommendedCourses.module.scss";

import image from "../../assets/main.jpeg";

const RecommendedCourses = () => {
  return (
    <section className={s.recommendedContainer}>
      <header className={s.recommendedContainer__header}>
        <img
          src={image}
          alt=""
          className={s.recommendedContainer__header__image}
        />
        <h3 className={s.recommendedContainer__header__image__title}>
          Recommended courses
        </h3>
      </header>
      <main className={s.recommendedContainer__main}>
        <div className={s.recommendedContainer__main__header}>
          <img
            width="75"
            height="75"
          ...
          />
          <h4 className={s.recommendedContainer__main__header__caption}>
            Unlocking Your Potential: Top Programming Courses of 2024
          </h4>
        </div>

        <div className={s.recommendedContainer__main__article}>
          <img
            width="75"
            height="75"
            ...
            alt="star"
          />
          <p className={s.recommendedContainer__main__article__content}>
            ...
            the most recommended programming courses for 2024.
          </p>
        </div>
      </main>
    </section>
